...
String ruleViolationMessage(Object error) {
  ...
  return switch (error.code) {
    ...
    'court_name_required' => '请输入场地名称。',
    'duplicate_court_name' => '本场已经有同名场地。',
    'court_capacity_reached' => '每场球局最多添加 8 块场地。',
    ...
    'two_waiting_players_required' => '单打至少需要 2 名候场球友。',
    'two_waiting_groups_required' => '双打至少需要 2 个候场搭档组。',
    'standard_21_requires_one_game' => '21 分赛只记录一局比分。',
    'quick_11_requires_one_game' => '11 分赛只记录一局比分。',
    'invalid_standard_21_score' => '请输入有效的 21 分羽毛球比分。',
    'invalid_quick_11_score' => '请输入有效的 11 分比分。',
    'match_format_mismatch' => '当前操作与本场的单打/双打形式不匹配。',
